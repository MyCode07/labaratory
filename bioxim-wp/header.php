...
<path d="M25 48.4375C37.9442 48.4375 48.4375 37.9442 48.4375 25C48.4375 12.0558 37.9442 1.5625 25 1.5625C12.0558 1.5625 1.5625 12.0558 1.5625 25C1.5625 37.9442 12.0558 48.4375 25 48.4375Z" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <form action="#" class="popup__form">
            <div class="popup__form-body">
                ...
                <input type="text" placeholder="Ваше имя" class="popup__form-name input-name _req" name="popup_name">
                <input type="text" placeholder="Ваш телефон" class="popup__form-phone _req" name="popup_phone">
                <div class="popup__form-confidence">
                    <input type="checkbox" class="_req" id="popup__agreement" checked>
                    <a href="https://salmin177.ru/privacy-policy" target="_blank" class="_link-underline" for="popup__agreement-text" id="popup__agreement-label">Я согласен с <mark> условиями обработки данных</mark></a>
                </div>
                <button type="submit" class="popup__form-btn blue-btn">отправить</button>
            </div>
        </form>
    </div>
</div>
